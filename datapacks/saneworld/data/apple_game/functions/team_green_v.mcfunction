...
tp @a[team=luck_red] 1235 100 1235
execute at @a[team=luck_green] run playsound minecraft:ui.toast.challenge_complete master @a[team=luck_green]
execute at @a[team=luck_red] run playsound minecraft:entity.wither.death master @a[team=luck_red]
title @a title [{"text":"游 戏 结 束","color":"aqua","bold":true}]
title @a subtitle [{"text":"幸运绿队获得本场游戏胜利","color":"green"}]
gamemode spectator @a[team=luck_red]
gamemode adventure @a[team=luck_green]
tp @a[team=luck_green] 1235 103 1229 0 0
clear @a
weather clear
